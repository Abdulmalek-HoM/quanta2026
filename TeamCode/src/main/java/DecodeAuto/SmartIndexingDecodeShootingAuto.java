...
/**
 * SmartIndexingDecodeShootingAuto v1.0 - SMART COLOR-BASED INDEXING
 * 
 ...
 */
@Config
@Autonomous(name = "Smart Indexing Decode Auto v1.0", group = "DecodeAuto")
public class SmartIndexingDecodeShootingAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Init telemetry
        telemetry.addData("Mode", "v1.0 SMART INDEXING");
        ...
        // Run SmartIndexAction in parallel to reorder balls based on detected pattern
