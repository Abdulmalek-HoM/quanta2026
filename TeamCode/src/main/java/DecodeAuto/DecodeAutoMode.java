        ...
        while (opModeIsActive()) {
            ...
            switch (currentState) {
                case DETECTING_RANDOMIZATION:
                    ...
                    if (detectedPattern != TagConfiguration.RandomizationPattern.UNKNOWN || stateTimer.seconds() > 5.0) {
                ...
                case ALIGNING_FOR_SHOOTING:
                    ...
                    int goalTagId = isRedAlliance ? 
                            TagConfiguration.ID_RED_SHOOTING_GOAL_CENTER : 
                            TagConfiguration.ID_BLUE_SHOOTING_GOAL_CENTER;
