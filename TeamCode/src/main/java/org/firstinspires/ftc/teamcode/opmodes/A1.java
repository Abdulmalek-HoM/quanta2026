...
public class A1 extends OpMode {
    ...
    public void loop() {
        ...
        // Speed Multiplier (Left Bumper usually Slow Mode in Manual, but here LB is Kick)
        ...
        if (gamepad1.right_bumper) {
            ...
            multiplier = 0.6; // Increased slightly from 0.5 for better response, or stick to 0.5? code had 0.5 default.
        }
        ...
        double botHeading = -botAngles.getYaw(AngleUnit.RADIANS); // Note: Manual uses DEGREES and converts manualy. Helper uses Radians typically.
